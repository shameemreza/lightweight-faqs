=== Lightweight FAQs ===
Contributors: orixlab, codechef
Donate link: https://ko-fi.com/shameemreza
Tags: accordion, collapsible, faqs, elementor faqs, stylish faq, lightweight, easy faq, ultimate faq
...
= CUSTOM SUPPORT =
If you are looking for WP Maintenance and Support or 
[WordPress Development](https://orixlab.net/wordpress-development-services/), you can discuss with us with your requirement.
...
1. Example of the lightweight faq on the front-end of the site.
2. FAQs options when using the Elementor.
2. FAQs options when using the classic Editor.
